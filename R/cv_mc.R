...
#' @title choose_variable
#' @description helper function(choose variables function) 
#' @param k the number of the first fixed variables
#' @param m the number of all variables
...
#' @title TSLS_SAIC
#' @description helper function(a simple Monte Carlo simulation to obtain properties of Model Averaging estimators using SAIC based on TSLS.) 
#' @param G the number of replications
#' @param T the number of observations
#' @param M the number of instrumental variables
#' @param Mfixed the number of first fixed instrumental variables
#' @return The function value
#' @examples
#' \dontrun{
#' TSLS_SAIC(5000, 100, 10, 2)
#' }
#' @import MASS 
